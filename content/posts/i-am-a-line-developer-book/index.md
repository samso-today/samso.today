...
## 책을 읽고 느낀 점
- LINE에 근무하고 계신 12분의 과거와 현재를 알 수 있어 좋았다. 누군가의 '100명~~~~' 이야기와 같이, 알게 모르게 사람들은 자신만의 unique한 발자취를 걸어가게 되고, 이를 알아가는 것은 굉장히 흥미롭다.
- 결국에 회사는 이러한 다양한 사람들이 모여 협업해야 하는 장소이기에, 소통 능력이 제일 중요하다는 생각이 많이 든다. 특히, '고맥락 / 저맥락으로 소통하기'는 책을 읽으며 가장 인상 깊어 앞으로 자주 사용하게 될 단어라 생각한다.
...
> p43. 기회는 누구에게나 주어지지만 그 기회를 잡을 준비가 되어 있느냐 아니냐는 각자의 문제라는 것을 요즘 많이 느끼고 있다. 하루를 최선을 다해 사는 것은 어렵지 않다. 어려운 건 매일매일 최선을 다하는 것이다. 지치기도 하고 지루하기도 할 테니까. 
